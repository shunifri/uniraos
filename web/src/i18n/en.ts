...
const en: Translations = {
  ...
  // Approval Center
  approval_empty: 'No pending tasks',
  approval_select_task: 'Select a task from the left',
  approval_claimed: 'Claimed',
  approval_pending: 'Pending',
  approval_task_id: 'Task',
  approval_comment: 'Comment',
  approval_comment_placeholder: 'Enter your comment...',
  ...
  skill_description_placeholder: 'Enter skill description',
  icon: 'Icon',
  visibility: 'Visibility',
  public: 'Public',
  private: 'Private',
  organization: 'Organization',
  handler_template_hint: 'Use async function with { params, context, deps }',
  help: 'Help',
  skill_dev_guide: 'Skill Development Guide',
  context_variables: 'Context Variables',
  example_skills: 'Example Skills',
