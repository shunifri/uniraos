const zh = {
  ...
  skill_description_placeholder: '请输入 Skill 描述',
  icon: '图标',
  visibility: '可见性',
  public: '公开',
  private: '私有',
  organization: '组织',
  handler_template_hint: '使用 async 函数，接收 { params, context, deps } 参数',
  help: '帮助',
  skill_dev_guide: 'Skill 开发指南',
  context_variables: '上下文变量',
  example_skills: '示例 Skill',
  parameter_name: '参数名',
  add_parameter: '添加参数',
  no_parameters_defined: '尚未定义参数',
  parameter_type: '类型',
  parameter_required: '必填',
  ...
  confirm_delete_skill: '确定要删除该 Skill 吗？',
